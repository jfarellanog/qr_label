...
for index, row in ubicaciones.iloc[0:].iterrows():
        ...
        fnt = ImageFont.truetype(r'C:\Users\jarellan\Desktop\qr_label\IN\Futura Bold font.ttf', 40)
        d = ImageDraw.Draw(img)
        d.text((20, 5), str(code), font=fnt, fill=(0, 0, 0))

        qr_big = qrcode.QRCode(error_correction=qrcode.constants.ERROR_CORRECT_H, box_size=7, border=1)
